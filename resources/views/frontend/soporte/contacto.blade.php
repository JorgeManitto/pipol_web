                ...
                <div class="card p-10 rounded-3xl">
                    <form class="space-y-6">
                        <div>
                            ...
                            <input type="text" class="w-full px-5 py-4 rounded-xl focus:outline-none focus:ring-2 transition-all text-md" style="background: var(--color-dark); border: 1px solid rgba(147, 21, 255, 0.3); color: white;" placeholder="Tu nombre">
                        </div>
                        <div>
                            <label class="block text-sm font-semibold mb-3 text-gray-300">Email</label>
                            <input type="email" class="w-full px-5 py-4 rounded-xl focus:outline-none focus:ring-2 transition-all text-md" style="background: var(--color-dark); border: 1px solid rgba(147, 21, 255, 0.3); color: white;" placeholder="tu@email.com">
                        </div>
                        <div>
                            <label for="motivo" class="block text-sm font-semibold mb-3 text-gray-300">Motivo</label>
                            <select name="motivo" id="motivo" class="w-full px-5 py-4 rounded-xl focus:outline-none focus:ring-2 transition-all text-md" style="background: var(--color-dark); border: 1px solid rgba(147, 21, 255, 0.3); color: white;">
                        ...
                        <div>
                            ...
                            <textarea rows="5" class="w-full px-5 py-4 rounded-xl focus:outline-none focus:ring-2 transition-all text-md" style="background: var(--color-dark); border: 1px solid rgba(147, 21, 255, 0.3); color: white;" placeholder="¿En qué podemos ayudarte?"></textarea>
                        </div>
                        <button type="submit" class="btn-primary w-full text-white px-6 py-4 rounded-xl font-bold text-md">
                            Enviar mensaje
                        </button>
                    </form>
                </div>
                ...
                <div class="space-y-6">
                    {{-- <div class="card p-8 rounded-3xl flex items-start gap-6">
                        ...
                        <div>
                            ...
                            <p class="text-gray-300 text-md">contacto@pipol.com</p>
                        </div>
                    </div> --}}
                    ...
                    <div class="card p-8 rounded-3xl flex items-start gap-6">
                        ...
                        <div>
                            ...
                            <p class="text-gray-300 text-md">Buenos Aires, Argentina</p>
                        </div>
                    </div>
