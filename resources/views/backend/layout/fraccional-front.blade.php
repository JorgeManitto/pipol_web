...
<body class="bg-gray-50">
    ...
    <nav class="nav">
        <a href="{{ route('home.fraccional') }}" class="nav-logo">
            <svg viewBox="0 0 28 28" fill="none"><rect x="2" y="2" width="10" height="10" rx="3" fill="#9b59f0"/><rect x="16" y="2" width="10" height="10" rx="3" fill="#9b59f0"/><rect x="2" y="16" width="10" height="10" rx="3" fill="#9b59f0"/><rect x="16" y="16" width="10" height="10" rx="3" fill="#9b59f0" opacity=".5"/></svg>
            Pipol
        </a>
        <div class="nav-links">
            <a href="{{ route('home') }}">Mentoría</a>
            <a href="{{ route('home.fraccional') }}" class="active">Fraccional</a>
            <a href="">Quiero ser talento</a>
