                    ...
                    <div class="flex-1">
                        <div class="flex items-baseline gap-2 mb-1">
                            <div class="flex gap-4">
                                <h3 class="font-semibold text-lg text-gray-900 hover:text-[#1a0a3e] transition-colors" id="nombre-modal-perfil">Nombre del Mentor</h3>
                            </div>
                ...
                <div class="flex items-center justify-between mt-4">
                    <div class="mb-5">
                        ...
                        <div class="flex flex-wrap gap-2" id="especialidades-modal-perfil">
                            <div class="px-3 py-1 bg-[#f5f0e8] text-[#1a0a3e] text-xs rounded-full hover:bg-[#e8dfcc] transition-colors tag"></div>
                        </div>
                    </div>
                    <p class="text-2xl font-bold text-[#1a0a3e] mb-4 pt-2 text-left" id="precio-modal-perfil"></p>
                </div>
            </div>
