...
<head>
    ...
    <title>Verificá tu email — Pipol</title>
</head>
                                ...
                                <tr>
                                    <td align="center" style="padding-bottom: 28px;">
                                        <p style="margin: 0; font-size: 14px; color: #9CA3AF; line-height: 1.6;">
                                            ¡Gracias por registrarte en Pipol! Solo falta un paso: confirmá tu dirección de correo haciendo clic en el botón de abajo.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td align="center" style="padding-bottom: 28px;">
                                        ...
                                        <w:anchorlock/>
                                        <center style="color:#ffffff;font-family:Helvetica,Arial,sans-serif;font-size:15px;font-weight:600;">Verificar email</center>
                                        </v:roundrect>
                                        <![endif]-->
                                        <!--[if !mso]><!-->
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <p style="margin: 0; font-size: 13px; color: #C4B5FD; line-height: 1.5;">
                                                        Este enlace expira en <strong style="color: #DDD6FE;">60 minutos</strong>. Si no creaste una cuenta en Pipol, podés ignorar este correo con tranquilidad.
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
